...
<script src="resources/recoverAccount.js"></script>
<style>
	.form-control{
  margin: auto;
  width: 50%;
...
<input type="email" name="email" id="email" class="form-control" placeholder="E-mail">
	<br>
	<br>
<button type="button" onclick="checkEmail()" name="sub" class="btn btn-default btn-lg" value=1 >Reset password</button>
